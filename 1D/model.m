 classdef model < handle & dynamicprops & matlab.mixin.Copyable
    ...
    methods
        ...
        function [meanAccelerationSections,meanErrSections] = plotFinalResults(obj)
        ...
        if strcmp(obj.simulationSettings.data,"Real")
            ...
            if plotSensorDependancy == true
                ...
                startSample = (start-start+1)*T;
                startControlSample = (startControl-start+1)*T;
                stopControlSample = (stopControl-start+1)*T;
                stopSample = (stop-start+1)*T;
                ...
                errSections = {};
                errSections{1} = err(:,[startSample:startControlSample]);
                errSections{2} = err(:,[startControlSample:stopControlSample]);
                errSections{3} = err(:,[stopControlSample:stopSample]);
                ...
                meanErrSections = [mean(abs(errSections{1}'));
                ...
                subplot(2,1,1)
                    ...
                    text((start+startControl)/2,-4.5e-4,0,'Section 1','horizontalAlignment','center','VerticalAlignment','bottom','color','r');
                    text((startControl+stopControl)/2,-4.5e-4,0,'Section 2','horizontalAlignment','center','VerticalAlignment','bottom','color','r');
                    text((stopControl+stop)/2,-4.5e-4,0,'Section 3','horizontalAlignment','center','VerticalAlignment','bottom','color','r');
